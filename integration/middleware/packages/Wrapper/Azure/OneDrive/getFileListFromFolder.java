package packages.Wrapper.Azure.OneDrive;
...
public final class getFileListFromFolder {

	static JsonObject mainflowJsonObject=null;
	static final String syncBlock=new String("sync");
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.Wrapper.Azure.OneDrive.getFileListFromFolder";
		long nanoSec=0;
		...
		try{
		  if(mainflowJsonObject==null)
			synchronized(syncBlock){
			  ...
			  String flowRef = location+"packages/Wrapper/Azure/OneDrive/getFileListFromFolder.flow";
			  if(mainflowJsonObject==null)
		  ...
		  FlowResolver.execute(dataPipeline,mainflowJsonObject);
			...
			new SnippetException(dataPipeline,"Failed to execute getFileListFromFolder", new Exception(e));
		}finally{
