package packages.middleware.pub.adapter.services.DML;
...
public final class insertAuditLogging {
		...
		try{
		  if(mainSqlJsonObject==null)
			synchronized(syncBlock){
			  ...
			  String flowRef = location+"packages/middleware/pub/adapter/services/DML/insertAuditLogging.sql";
			  if(mainSqlJsonObject==null)
