package packages.ekaScheduler.cronJob.adapter.services.DDL;
		...
		try{
		  if(mainSqlJsonObject==null)
			synchronized(syncBlock){
			  ...
			  String flowRef = location+"packages/ekaScheduler/cronJob/adapter/services/DDL/historyTables.sql";
			  if(mainSqlJsonObject==null)
