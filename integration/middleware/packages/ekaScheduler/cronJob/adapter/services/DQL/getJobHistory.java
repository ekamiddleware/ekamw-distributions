package packages.ekaScheduler.cronJob.adapter.services.DQL;
		...
		try{
		  if(mainSqlJsonObject==null)
			synchronized(syncBlock){
			  ...
			  String flowRef = location+"packages/ekaScheduler/cronJob/adapter/services/DQL/getJobHistory.sql";
			  if(mainSqlJsonObject==null)
