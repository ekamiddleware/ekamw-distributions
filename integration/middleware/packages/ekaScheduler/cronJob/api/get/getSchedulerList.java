		...
		try{
		  if(mainflowJsonObject==null)
			synchronized(syncBlock){
			  ...
			  String flowRef = location+"packages/ekaScheduler/cronJob/api/get/getSchedulerList.flow";
			  if(mainflowJsonObject==null)
		  ...
		  FlowResolver.execute(dataPipeline,mainflowJsonObject);
			...
			new SnippetException(dataPipeline,"Failed to execute getSchedulerList", new Exception(e));
		}finally{
