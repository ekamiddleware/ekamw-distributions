package packages.ekaScheduler.cronJob.api.get;
...
public final class getSchedulerJobByID {

	static JsonObject mainflowJsonObject=null;
	static final String syncBlock=new String("sync");
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.ekaScheduler.cronJob.api.get.getSchedulerJobByID";
		long nanoSec=0;
		...
		try{
		  if(mainflowJsonObject==null)
			synchronized(syncBlock){
			  ...
			  String flowRef = location+"packages/ekaScheduler/cronJob/api/get/getSchedulerJobByID.flow";
			  if(mainflowJsonObject==null)
		  ...
		  FlowResolver.execute(dataPipeline,mainflowJsonObject);
			...
			new SnippetException(dataPipeline,"Failed to execute getSchedulerJobByID", new Exception(e));
		}finally{
