package packages.ekaScheduler.cronJob.api.delete;
...
public final class deleteSchedulerJob {

	static JsonObject mainflowJsonObject=null;
	static final String syncBlock=new String("sync");
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.ekaScheduler.cronJob.api.delete.deleteSchedulerJob";
		long nanoSec=0;
		...
		try{
		  if(mainflowJsonObject==null)
			synchronized(syncBlock){
			  ...
			  String flowRef = location+"packages/ekaScheduler/cronJob/api/delete/deleteSchedulerJob.flow";
			  if(mainflowJsonObject==null)
		  ...
		  FlowResolver.execute(dataPipeline,mainflowJsonObject);
			...
			new SnippetException(dataPipeline,"Failed to execute deleteSchedulerJob", new Exception(e));
		}finally{
