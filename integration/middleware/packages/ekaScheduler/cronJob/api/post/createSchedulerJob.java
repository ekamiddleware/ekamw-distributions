...
public final class createSchedulerJob {

	static JsonObject mainflowJsonObject=null;
	static final String syncBlock=new String("sync");
	public static final void main(DataPipeline dataPipeline) throws SnippetException{
		String fqn="packages.ekaScheduler.cronJob.api.post.createSchedulerJob";
		long nanoSec=0;
		...
		try{
		  if(mainflowJsonObject==null)
			synchronized(syncBlock){
			  ...
			  String flowRef = location+"packages/ekaScheduler/cronJob/api/post/createSchedulerJob.flow";
			  if(mainflowJsonObject==null)
		  ...
		  FlowResolver.execute(dataPipeline,mainflowJsonObject);
			...
			new SnippetException(dataPipeline,"Failed to execute createSchedulerJob", new Exception(e));
		}finally{
