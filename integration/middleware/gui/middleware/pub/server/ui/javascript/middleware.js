        ...
        .jstree(
            {
                ...
                "types" : {
                    "default" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/doc.svg",
                        "valid_children" : [
                    ...
                    "string" : {
                        ...
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/textArr.svg",
                        "valid_children" : []
                    },
                    "javaObject" : {
                        ...
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/javaObjectArr.svg",
                        "valid_children" : []
                    },
                    "integer" : {
                        ...
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/integerArr.svg",
                        "valid_children" : []
                    },"number" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/number.svg",
                        "valid_children" : []
                    },"numberList" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/numberArr.svg",
                        "valid_children" : []
                    },"date" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/date.svg",
                        "valid_children" : []
                    },"dateList" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/dateArr.svg",
                        "valid_children" : []
                    },"boolean" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/boolean.svg",
                        "valid_children" : []
                    },"booleanList" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/booleanArr.svg",
                        "valid_children" : []
                    },"byte" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/byte.svg",
                        "valid_children" : []
                    },"byteList" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/byteArr.svg",
                        "valid_children" : []
                    }
                },
                "plugins" : [ "unique",
        ...
        .jstree(
            {
                ...
                "types" : {
                    "default" : {
                        "icon" : "/files/gui/middleware/server/ui/icons/sequence.svg",
                        "valid_children" : [
                    ...
                    "switch" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/switch.svg",
                        "valid_children" : [
                            "default","sequence", "switch","loop","repeat","try-catch","map","invoke"]
                    },
                    "loop" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/loop.svg",
                        "valid_children" : [
                            "default","sequence", "switch","loop","repeat","try-catch","map","invoke"]
                    },
                    "repeat" : {
                    ...
                    "try-catch" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/try-catch.svg",
                        "valid_children" : [
                            "default","sequence", "switch","loop","repeat","try-catch","map","invoke"]
                    },
                    "map" : {
                    ...
                    "invoke" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/invoke.svg",
                        "valid_children" : []
                    }
                },
                "plugins" : [
...
function deleteArtifact(filePath){
    ...
    swal({
            title: "Are you sure to delete this this?",
            text: "Service references:-\n\n"+JSON.stringify(list)+"\n\nAre you sure you want to delete ('"+filePath+"') ?",
            type: "warning",
        ...
        function(isConfirm){
            if (isConfirm) {
                ...
                swal("Cancelled !!", "Hey, your designation is safe !!", "error");
            }
        });
}
        ...
        .jstree(
            {
                ...
                "types" : {
                    ...
                    "root" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/myPackage.svg",
                        "valid_children" : [
                            "package"]
                    },"ui-root" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/ui.svg",
                        "valid_children" : [
                            "gui-app"]
                    },"package" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/myPackages.svg",
                        "valid_children" : [
                            "folder"]
                    },"gui-app" : {
                    ...
                    "folder" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/filesystem/folder.svg",
                        "valid_children" : [
                            "folder", "service","package","flow","map","html","js","css","jar","jdbc","sql","properties"]
                    },"service" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/filesystem/cog.svg",
                        "valid_children" : []
                    },"map" : {
                        ...
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/properties.svg",
                        "valid_children" : []
                    },"html" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/html.svg",
                        "valid_children" : []
                    },"js" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/js.svg",
                        "valid_children" : []
                    },"css" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/css.svg",
                        "valid_children" : []
                    },"flow" : {
                        "icon" : "/files/gui/middleware/pub/server/ui/icons/flow.svg",
                        "valid_children" : []
                    },"jar" : {
...
function validateNewItemName(name) {
    ...
    for(var i=0 ; i < childrens.length ; i++) {
        ...
        console.log(childrens[i].innerText.trim());
    }
    return true;
}
...
function createSchema(type,ref,selected,text) {
    ...
    console.log(type);
    if (type == "package" || type == "folder" || type == "flow" || type == "service" || type == "jdbc" || type == "sql" ||
        type == "properties" /*||
        ...
        text = prompt("Enter name of " + type);//openNameItemPromptForm();
    ...
    sel = /*ref.create_node(sel, {
                                "text" : text,
								"type" : type
							});*/ createNewVariable(sel, ref, text, type, 0);
    if (sel){
        if(type=="try-catch"){
